...
public class DynamicArm extends Command {
  ...
  private static final double MAX_EXTENSION = Units.inchesToMeters(24.0); // Maximum extension length converted to meters
  private static final double WRIST_LENGTH = Units.inchesToMeters(8.0); // Length of wrist segment in meters
