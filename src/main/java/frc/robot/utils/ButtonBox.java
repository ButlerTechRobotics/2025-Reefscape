...
/**
 * A custom wrapper for GenericHID that provides named access to buttons on a button box. This
 * allows for more readable code when binding commands to buttons.
 *
 * <p>Usage example:
 *
 * <pre>
