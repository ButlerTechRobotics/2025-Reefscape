 ...
 * leader motor, and an encoder for precise angular positioning.
 */
public class ClawJointIOCTRE implements ClawJointIO {
   ...
   * configuring both motors, and optimizing CAN bus utilization for all devices.
   */
  public ClawJointIOCTRE() {
    // Configure the motors and encoder
   ...
   */
  @Override
  public void updateInputs(ClawJointIOInputs inputs) {
    ...
    inputs.clawAngle = inputs.encoderPosition;
  }
  ...
  /** Stops all arm movement by stopping the leader motor. */
  @Override
  public void stop() {
    leader.stopMotor();
  }
